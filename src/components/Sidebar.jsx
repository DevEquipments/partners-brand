  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div
          className={`flex items-center h-15 border-b border-zinc-800 shrink-0
        ...
        {/* Nav */}
        <nav
          className={`flex-1 overflow-y-auto py-3 ${isCollapsed ? "px-2" : "px-2"}`}
        >
          {!isCollapsed && (
            <p className="text-[9px] font-bold text-zinc-600 uppercase tracking-[0.15em] mb-2 px-2">
              Main Menu
            </p>
          )}
        ...
        {/* Bottom */}
        <div
          className={`border-t border-zinc-800 shrink-0 py-3 ${isCollapsed ? "px-2" : "px-2"} space-y-0.5`}
        >
          {/* User chip */}
          {!isCollapsed && (
            <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-zinc-800 mb-1">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[12px] font-semibold text-zinc-100 truncate uppercase">
                  {displayName}
                </p>
