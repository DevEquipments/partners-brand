...
const Navbar = ({ onMenuToggle }) => {
  ...
  return (
    ...
    <header className="h-[60px] bg-white border-b border-slate-200 shrink-0 flex items-center px-5 md:px-6 gap-4 z-30">
      ...
      {/* Search */}
      <div className="hidden md:flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 w-60
      ...
      <div className="flex items-center gap-2.5">
        <div className="hidden md:flex flex-col items-end">
          <span className="text-[13px] font-semibold text-slate-800 leading-tight">{displayName}</span>
          <span className="text-[10px] text-slate-400 font-medium">Brand Partner</span>
        </div>
